...
public class OrchestrationService {
    ...
    public SmartCityRouteResponse planRoute(String zone) {
        ...
        SmartCityRouteResponse.AirQualitySection airSection =
                new SmartCityRouteResponse.AirQualitySection();
        ...
        if (zoneInfo != null) {
            SmartCityRouteResponse.ZoneOverviewSection zoneSection =
                    new SmartCityRouteResponse.ZoneOverviewSection();
    ...
    // dans la classe OrchestrationService (ajoute sous les autres méthodes)
